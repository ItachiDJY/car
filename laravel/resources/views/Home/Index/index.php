...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="Content/main@977f78b8d9.css" />
...
<form action="" id="loginTopForm" target="_parent" method="post">
...
<div class="zc_head_bd">
    <div class="zc_main">
        ...
        <div class="zcindex_login" >
            <span id="logo" style="display: none"><?php echo $username?></span>
            <div class="wdl" id="bb">
                ...
                <a href="/login" class="colc8c8ce ml20" onClick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','首页-我的神州（顶）')">我的神州</a>
            </div>
            ...
            <div class="ydl"  style="display: none;" id="aa">
                ...
                <div class="zc_index_my">
                    ...
                    <div class="contmyszlist">
                        <div class="p-re">
                            <span class="y">◆</span>
                            <a href="" class="bhpr reddot"  onClick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','我的神州-我的订单')">我的订单

                            </a>
                            <a href="">我的资产</a>
                            <a href="/person/account">我的账户</a>
                            <a href="/login/out_login" onClick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','我的神州-退出登陆')">退出登录</a>
                        </div>
                    </div>
                </div>
                <div class="clear"></div>
        ...
        <div>
            ...
            <div class="indexContents cur" >
                <div class="zc_index_dz bhnew">
                    <input type="hidden" id="currentDate" name="currentDate" value="2017-05-23 12:29:00">
                    ...
                    <dl class="zc_item_cont fl outpre">
                        ...
                        <dd>
                            <input type="text" home-flag="true" value="石家庄" default-value="选择城市"
                        ...
                        <dd>
                            ...
                            <input type="text" value="正定机场店" default-value="请选择取车门店"
                            ...
                            <input type="hidden" name="fromStoreId" id="fromStoreId" value="959">
                    ...
                    <dl class="zc_item_cont fr bhmt15 outpre">
                        ...
                        <dd>
                            ...
                            <input type="text" value="正定机场店" default-value="请选择还车门店"
                            ...
                            <input type="hidden" name="toStoreId" id="toStoreId" value="959">
                    ...
                    <dl class="zc_item_cont bhmt25 w459">
                        ...
                        <dd class="p-re h76 ddfl">
                            <input type="text" value="2017-05-24" class="inputDay bmnone zc_iptcalendar iptDate dt-left"
                        ...
                        <dd class="p-re h76 ddfr">
                            <input type="text" value="2017-05-26" class="inputDay bmnone zc_iptcalendar iptDate dt-right"
    ...
    <div class="zc_main">
        <ul>
            <li>
                ...
                <div class="zj"></div>
                <p>24小时轻松取 / 还车</p>
                <a href="/door" onClick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','首页-短租-我要租车')">我要租车</a>
            </li>
            <li class="ml20">
                <h2>长租服务</h2>
                <div class="cz"></div>
                <p>长租一次告别常租</p>
                <a href="/long" onClick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','首页-长租-我要租车')">我要租车</a>
            </li>
            <li class="ml20">
                <h2>企业租车</h2>
                <div class="qy"></div>
                <p>企业出行一步搞定</p>
                <a href="/company" onClick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','首页-企业-我要租车')">我要租车</a>
            </li>
            <li class="ml20">
                <h2>顺风车站</h2>
                <div class="sfc"></div>
                <p>价格便宜就是任性</p>
                <a href="/free" onClick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','首页-顺风车-我要租车')">我要租车</a>
            </li>
        </ul>
    </div>
</div>
									...
									<div class="cardiv">
										<a href="https://order.zuche.com/specialCar{{>key}}-2.html">
											...
											<div class="picbox">
												...
												<img class="car_mask" src="Picture/car_mask.png" width="385" height="260">
											</div>
										</a>
									</div>
								{{/for}}
	...
	{{/if}}
        ...
        <div class="sale-r sbox">
            ...
            <div class="salebox sfclist">
                <img class="sfc-empty" src="Picture/sfc_null.jpg">
                <ul class="rotar" >
                    <li class="rotarli">
                        <div class="sfcdiv">
                            <a  href="javascript:void(0);" onclick="javascript:window.location.href='https://easyride.zuche.com/order/convenienceInfo/226309.html';">
                                <div class="sfctop">
                                    <div class="pricebox">
                                        <span class="pricebl">¥100</span>
                                        <span class="priceori">原价:￥1198</span>
                                    </div>
                                    <div class="picbox">
                                        <img class="bhmove" src="Picture/ly.jpg" alt="" width="320" height="180">
                                        <img class="car_mask" src="Picture/car_mask.png" width="385" height="260">
                                    </div>
                                </div>
                                <div class="sfcbotm">
                                    <div class="distance">
                                        ...
                                        <div class="carinfo">
                                            <p>大众朗逸</p>
                                            <p class="fs14">大众朗逸/三厢/1.6自动   乘坐5人</p>
                                        </div>
                                    </div>
                                </div>
                            </a>
                    ...
                    <li class="rotarli">
                        <div class="sfcdiv">
                            <a  href="javascript:void(0);" onclick="javascript:window.location.href='https://easyride.zuche.com/order/convenienceInfo/226580.html';">
                                <div class="sfctop">
                                    <div class="pricebox">
                                        <span class="pricebl">¥100</span>
                                        <span class="priceori">原价:￥1048</span>
                                    </div>
                                    <div class="picbox">
                                        <img class="bhmove" src="Picture/ly.jpg" alt="" width="320" height="180">
                                        <img class="car_mask" src="Picture/car_mask.png" width="385" height="260">
                    ...
                    <li class="rotarli">
                        <div class="sfcdiv">
                            <a  href="javascript:void(0);" onclick="javascript:window.location.href='https://easyride.zuche.com/order/convenienceInfo/226576.html';">
                                <div class="sfctop">
                                    <div class="pricebox">
                                        <span class="pricebl">¥100</span>
                                        <span class="priceori">原价:￥1059</span>
                                    </div>
                                    <div class="picbox">
                                        <img class="bhmove" src="Picture/gl8.jpg" alt="" width="320" height="180">
                                        <img class="car_mask" src="Picture/car_mask.png" width="385" height="260">
                                    </div>
                                </div>
                                <div class="sfcbotm">
...
<div class="zc_i_sale_acy z-graybg">
    <div class="zc_main">
        <div>
            ...
            <div class="activityScroll">
                ...
                <div class="bd">
                    <ul class="picList">
                                    <li data="1100">
                                        <a href="https://huodong.zuche.com/activityplanning/topic/osmayday.html?szhdbm=20170412_mayday_web" id="newspicture" target="_blank"><img src="Picture/20170421wuyigengxin_pclist.jpg" width="285" height="215"></a>
                                        <div class="pl10">
                                    ...
                                    <li data="1107">
                                        <a href="http://huodong.zuche.com/activityplanning/topic/SPDBankScard.html?szhdbm=20170509_spd_web" id="newspicture" target="_blank"><img src="Picture/20170510pufa_pclist.jpg" width="285" height="215"></a>
                                        <div class="pl10">
                                    ...
                                    <li data="1105">
                                        <a href="http://huodong.zuche.com/activityplanning/topic/incomingnewcar.jsp?szhdbm=20170502_inc_web" id="newspicture" target="_blank"><img src="Picture/20170502wanliang69_pclist.jpg" width="285" height="215"></a>
                                        <div class="pl10">
                                    ...
                                    <li data="1110">
                                        <a href="http://huodong.zuche.com/activityplanning/topic/sectionDuanWu.html?szhdbm=20170519_sdw_web&utm_source=guanwang&utm_medium=web&utm_campaign=duanwu" id="newspicture" target="_blank"><img src="Picture/20170519duanwu_pclist.jpg" width="285" height="215"></a>
                                        <div class="pl10">
                    ...
                    <ul class="picList">
                        <li>
                            <a href="https://huodong.zuche.com/activityplanning/topic/followzuche5.html?szhdbm=20161111weixin_web" onclick="dcsMultiTrack('DCS.dcsuri', '/virtual/index/AD_R3/20140723.event','WT.ti_event', '首页-右广告3-关注微信','WT.mc_click','首页-活动5-图')" target="_blank">
                                <img src="Picture/20161228wechat.jpg" width="285" height="215" alt="关注微信">
                            </a>
                            <div class="pl10">
                                <h3>关注微信 领20元租车券！</h3>
                        ...
                        <li>
                            <a href="https://huodong.zuche.com/activityplanning/topic/SPDBankScard.html?szhdbm=20170509_spd_web" onclick="dcsMultiTrack('DCS.dcsuri', '/virtual/index/AD_R3/20140723.event','WT.ti_event', '首页-右广告3-御驾黑卡','WT.mc_click','首页-活动5-图')" target="_blank">
                                <img src="Picture/20170510spd_list.jpg" width="285" height="215" alt="御驾黑卡">
                            </a>
                            <div class="pl10">
                        ...
                        <li>
                            <a href="https://huodong.zuche.com/activityplanning/topic/lowprice.html" target="_blank" onClick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','首页-活动1-图')">
                                <img src="Picture/20160311pc_news_03.jpg" width="285" height="215" alt="月租超低价">
                            </a>
                            <div class="pl10">
                                <h3>超值优惠 低至6折！</h3>
                                <p class="f14">
                        ...
                        <li>
                            <a href="http://www.gohertz.cn/infor/special_offers/global-offer-10-off" target="_blank" onClick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','首页-活动4-图')">
                                <img src="Picture/20160909hertz_web.jpg" width="285" height="215" alt="赫兹全球租车 点我直达！">
                            </a>
                            <div class="pl10">
                                <h3>赫兹全球租车 点我直达！</h3>
                        ...
                        <li>
                            <a href="https://huodong.zuche.com/activityplanning/topic/ojnewmemebr.html?szhdbm=20161031new150_pc" onclick="dcsMultiTrack('DCS.dcsuri', '/virtual/index/AD_R3/20140723.event','WT.ti_event', '首页-右广告3-新用户留步150元请收下','WT.mc_click','首页-活动5-图')" target="_blank">
                                <img src="Picture/20170220newmember_list.jpg" width="285" height="215" alt="新用户留步150元请收下">
                            </a>
                            <div class="pl10">
                                <h3>新用户留步 150元请收下</h3>
        ...
        <div class="zc_but_box"><a href="/activity" target="_blank" class="moreabox" onClick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','活动-更多优惠')">更多优惠></a> </div>
        ...
        <ul>
            <li>
                <a href="https://news.zuche.com/gsdt/info1108.html" target="_blank">
                    <img src="Picture/20170516bandr_list.jpg" alt="神州租车大数据解读“一带一路神州游”" width="285" height="215">
            ...
            <li>
                <a href="https://news.zuche.com/gsdt/info1109.html" target="_blank">
                    <img src="Picture/20170519news_list.jpg" alt="神州租车一季度客户数量同比增3成" width="285" height="215">
                    <div class="news_title">
            ...
            <li>
                <a href="https://news.zuche.com/gsdt/info1070.html" target="_blank">
                    <img src="Picture/20160905shangmen_pc.jpg" alt="神州租车“免费上门送取车”再树行业新标杆" width="285" height="215">
                    <div class="news_title">
            ...
            <li>
                <a href="https://news.zuche.com/gsdt/info1066.html" target="_blank">
                    <img src="Picture/20160726carmarket_pc.jpg" alt="神州优车挂牌新三板首日市值超400亿元" width="285" height="215">
                    <div class="news_title">
...
<div class="rightsj">◆<span class="arrowicon">◆</span></div>
                    <dl>
                        ...
                        <dd class="carimg">
                            <img src="Picture/ed8113693bc145f58741ffde75fd51a5.gif" width="132" height="76">
                        </dd>
...
<div id='doorDiv' class="door d_none popup_block" mask-data="#?w=860">
    ...
    <textarea id="J_gaodemapLoad" style="display:none;">
        <script type="text/javascript" src="Scripts/344df58c9e514371945d695f941682be.js"></script>
    </textarea>
</div>
...
<script type="text/javascript" src="Scripts/seaconfig@c8a261554c.js"></script>
<!--[if lte IE 7]>
<script type="text/javascript" src="Scripts/json2@fad58c0e6e.js"></script>
<![endif]-->
<script type="text/javascript" >
    seajs.use([
    ...
    var __currentdatetime = '2017-05-23 12:29:00';
    var pageSystemDate='2017-05-23 12:29:00';
    var __nextdatetime = '2017-05-24';
    var __next2datetime = '2017-05-26';
...
<head>
    ...
    <script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=gny11cGPmZYS9o3MUMcHg7ZyqacYG9Ih"></script>
