    			 ...
    			 <?php foreach ($data as $key => $val): ?>
    			 	<dd class="list-item">
			    				<a href="javascript:void(0)" class="closed">
									<img class="fav-img" src="../<?= $val['active_img']?>" alt="<?= $val['active_name']?>">
									<h3 class="fav-title"><?= $val['active_name']?></h3>
		    					<p class="fav-con"><?= $val['active_describe']?>"</p>
		    					<div class="img-cover"></div>
		    					</a>
		    					
		    					<div class="fav-state <?= $val['css']?>"><p>活动<br><?= $val['status']?></p></div>
		    					</dd>
	    		
    			 <?php endforeach ?>
	    		</dl>
            <div class="load-more" id ="load_more">暂无更多......</div>
