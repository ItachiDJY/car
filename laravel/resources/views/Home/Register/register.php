...
<div class="zc-pbox">
    <div class="zc-inbox">
        <div class="reg-l">
            ...
            <form id="myform" name="myform" autocomplete="off" action="/register/register" method="post">
                <ul>
                    <li class="zc-iptbox">
                        <span class="rstar">*</span>
                        <label><span class="zc-iuser"></span></label>
                        <input name="user_name" id="xname" class="zc-ipt t_val" type="text" placeholder="请输入您的真实姓名(2-5个汉字)"  maxlength="20" >
                    ...
                    <li class="zc-iptbox">
                        ...
                        <input name="user_phone" id="xmobile" class="zc-ipt t_val" type="text"  maxlength="11" placeholder="请输入您的手机号">
                    ...
                    <li class="zc-iptbox" style="height:40px;">
                        ...
                        <input class="zc-iptsht t_val" name="validateCode" id="validateCode" type="text" placeholder="请输入手机动态码" maxlength="6"  autocomplete="off">
                        <span class="btn-dtm btn-getdtm" id="getYzmBtn">
                            <font id="phone_code">获取手机动态码</font>
                    ...
                    <li class="zc-iptbox">
                        ...
                        <input class="zc-ipt ipt-passwordH"  type="password" id="xpassword" placeholder="密码长度为6-18位" maxlength="20" style="display:none">
                        <input class="zc-ipt ipt-passwordS" name="user_pwd" type="text" id="xpassword1"  placeholder="密码长度为6-18位" maxlength="20">

                        <span class="span_pwd"></span>
                    </li>

                </ul>
                <p class="lfwtk"><input class="zc-yes zc-rayes" type="checkbox" checked="checked"><span class="zc-yes zc-blyes"></span>我已阅读并同意<a href="https://huodong.zuche.com/jsp/common/rulesKJT.html" target="_blank">《神州租车会员服务条款》</a></p>
                <!--				<a class="zc-btn btn-reg" href="javascript:void(0);" id="nextButton" onClick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','注册页-注册按钮','WT.regSuccess','1');window.LCTJ&&window.LCTJ.putBe({type:3,name:'注册页-注册按钮'})">注册</a>-->
                <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                <input type="submit" value="注册" class="zc-btn btn-reg" id="nextButton">
            </form>
                ...
                function timer(intDiff){
                    window.setInterval(function(){
                        ...
                        if(intDiff > 0){
                            ...
                            code = Math.round((Math.random()*(99999-10000)+1)+10000);
                            //$("#getYzmBtn").show();
//                                  $("#phone_code").show();
//                                  $(".time-item").hide();
                            history.go(0)
                ...
                $(document).on("click","#getYzmBtn",function(){

                    var user_phone = $("#xmobile").val();
                    var reg_phone=/^1[3,5,8,7]\d{9}$/;

                    if(user_phone == "") {
                        $(".span_code").html("<font color='red'>请先输入手机号!</font>");
                    } else {
                        if(reg_phone.test(user_phone)) {
                            $.ajax({
                                type: "get",
                            ...
                            $(".span_code").html("<font color='red'>手机号格式不正确!</font>");
                        }
                    }
                })
                ...
                $("#validateCode").blur(function(){
                    ...
                    if(user_code == "") {
                        ...
                        if(user_code == code) {
                            ...
                            $(".span_code").html("<font color='red'>验证码输入有误</font>");
                        }
                    }
                })
                ...
                $("#xpassword1").blur(function(){
                    var user_pwd = $("#xpassword1").val();
                    var reg_pwd =/^\w{6,18}$/;
                    if (user_pwd == "") {
                        $(".span_pwd").html("<font color='red'>密码不能为空!</font>");
                    } else {
                        if (reg_pwd.test(user_pwd)) {
                            $(".span_pwd").html("<font color='green'>√</font>");
                            flag_pwd = 1;
                        } else {
                            $(".span_pwd").html("<font color='red'>密码为6-18位组成!</font>");
                        }
                    }
                })
        ...
        <div class="reg-r">
            <p class="reg-title rtitle">已有账号？<a href="/login" rel="nofollow" onClick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','注册页立即登录');window.LCTJ&&window.LCTJ.putBe({type:3,name:'注册页-立即登陆'})">立即登录&nbsp;»</a></p>
            <div class="wapbox" style="padding:0px;border:0px;">
                <img class="qcode" src="Picture/tipsregist.png" usemap="#Map">
                <map name="Map">
                ...
                <div style="display:none;">
                    ...
                    <img class="qcode" src="Picture/qcode.jpg">
...
<div class="zc_footcopyright">
    ...
    <a href="https://js.zuchecdn.com">111</a>
</div>
<!--foot end -->
...
<script type="text/javascript">
    seajs.use(['divided/lm/entry/lib@eb8e0cf87c.js'],function(){
        seajs.use('divided/lm/entry/register@dd5ff875d7');
        $(function(){
