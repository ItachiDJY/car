...
<head>
    ...
    <meta name="WT.quChe_city_Second" content="石家庄" />
    <meta name="WT.huanChe_city_Second" content="石家庄" />
    <meta name="WT.quChe_menDian_Second" content="正定机场店" />
...
<input type = "hidden" id="mebId" value = '17366592'>
...
<div class="zc_headlist zc_boxshd">
    <form id="firstOrderInfo" style="height: auto;">
                ...
                <div class="choose_ul">
                    ...
                    <div class="ch_box cardate" style="z-index:3;">
                        ...
                        <div class="ch_box divin">
                            <input type="text" value="2017-05-24" class="iptdate zc_iptcalendar" name="fromDate" id="fromDate" readonly="readonly" autocomplete="on">
                        </div>
                    ...
                    <div class="ch_box cardate mt10 p-re">
                        <label class="c_date">还车时间
                            <div class="indexjmhS fromdatetips dayS toDateWeek">28天</div>
                        </label>
                        <div class="ch_box">
                            <input type="text" value="2017-06-21" class="wdate iptDate iptdate zc_iptcalendar" readonly="readonly" name="toDate" id="toDate">
                        </div>
                        <div class="ch_box">
        ...
        <script>
            ...
            //租车下订单
            $(document).on('click' ,'.rent_car',function(){
                var fromStoreId = $('#fromStoreId').val();
                var toStoreId = $('#toStoreId').val();
                var fromDate = $('#fromDate').val();
                var toDate = $('#toDate').val();
                ...
                window.location.href ='/rent_car?car_id='+car_id+'&fromStoreId='+fromStoreId+'&toStoreId='+toStoreId+'&fromDate='+fromDate+'&toDate='+toDate+'&fromHourMinute='+fromHourMinute+'&toHourMinute='+toHourMinute+'&pre_days='+pre_days;
            })
        </script>
        ...
        <input type="hidden" id="rentDay" name="rentDay" value="28"/>
        ...
        <input type="hidden" id="memberLevel" name="memberLevel" value="1" />
        <input type="hidden" id="selectedActivityCode" name="selectedActivityCode" value="" />
        <input type="hidden" name="checkMemberId" id="checkMemberId" value="17366592"/>
        <input type="hidden" value="shortRent" id="shortColor" name="shortColor"/>
        <input type="hidden" id="_form_uniq_id" name="_form_uniq_id" value="wCYbSsxNJRvakzPL1RGcEPsNpraTLlCS" />
        <input type="hidden" id="firstStep_carList" name="firstStep_carList" value="first_carList" />
        <input type="hidden" id="fromStoreNameTip" name="fromStoreNameTip" value="正定机场店" />
        <input type="hidden" id="changeRentDay" name="changeRentDay" value="0" />
        <input type="hidden" id="smfwFlag" name="smfwFlag" value="" />
    </form>
</div>
...
<div class="zc_main zc_carcon">
    <div class="zc_leftlist fl">
        <div class="zc_boxshd lchoose_box">
            <div class="cl-lbox bdbtm orderLevel">
                ...
                <ul class="chexing">
                    <li class="orderlevelcheck filter_level all">
                        <a class="car_d checked cxdefault" href="javascript:void(0);">
                            <i class="zc_cx_bx"></i>
                            <i class="cartxt" ids="0">不限</i>
                        </a>
                    </li>
                    <?php foreach($deploy_data as  $v):?>
                    <li class="orderlevelcheck filter_level brandname">
                        <a href="javascript:void(0);" class="car_d">
            ...
            <div class="cl-lbox bdbtm orderRent price1">
                ...
                <ul class="pri_range">
                    <li class="bar1 orderlevelcheck filter_rent_money all"><a class="car_price checked jgdefault" data="0"><span class="w40"></span></a></li>
                    <li class="bar2 prli orderlevelcheck filter_rent_money"><a href="javascript:void(0);" class="car_price" data="0-150"><span class="w40"></span></a></li>
                    <li class="bar3 prli orderlevelcheck filter_rent_money"><a href="javascript:void(0);" class="car_price" data="150-300"><span class="w40"></span></a></li>
                    <li class="bar4 prli orderlevelcheck filter_rent_money"><a href="javascript:void(0);" class="car_price" data="300-500"><span class="w40"></span></a></li>
                    <li class="bar5 prli orderlevelcheck filter_rent_money"><a href="javascript:void(0);" class="car_price" data="500-*"><span class="w70"></span></a></li>
                </ul>
                <ul class="pri_num">
            ...
            <div class="cl-lbox bdbtm orderBrand">
                ...
                <ul class="car_brand">
                    <li class="orderlevelcheck filter_brand all"><a class="brand_select checked ppdefault" ids="">不限</a></li>
                    <?php foreach($brand_data as $v ):?>
                    <li class="orderlevelcheck filter_brand brandname"><a href="javascript:void(0);" class="brand_select" ids="<?=$v['brand_id']?>" ><?=$v['brand_name']?></a></li>
                   
                    <?php endforeach;?>
                </ul>
            </div>
        </div>
        <input type="hidden" id="car_d" value="0">
        <input type="hidden" id="car_price" value="0">
        <input type="hidden" id="brand_select" value="0">
        <script> 
                //车型图标切换   
                $('.car_d').on('click',function(){
                   // alert(123);
                    var _this = $(this);
                    _this.hasClass('checked cxdefault') ? _this.parent().siblings().find('a').removeClass('checked cxdefault') : _this.addClass('checked cxdefault').parent().siblings().find('a').removeClass('checked cxdefault');
                    var car_deploy = $(this).find('.cartxt').attr('ids');
                    $('#car_d').val(car_deploy);
                ...
                //价格切换  
                $('.car_price').on('click',function(){
                   
                    var _this = $(this);
                    _this.hasClass('checked jgdefault') ? _this.parent().siblings().find('a').removeClass('checked jgdefault') : _this.addClass('checked jgdefault').parent().siblings().find('a').removeClass('checked jgdefault');
                    var price = _this.attr('data') ;
                    $('#car_price').val(price);
                    loadData();
                })
                ...
                $('.brand_select').on('click',function(){
                    ...
                    var _this = $(this);
                    _this.hasClass('checked ppdefault') ? _this.parent().siblings().find('a').removeClass('checked ppdefault') : _this.addClass('checked ppdefault').parent().siblings().find('a').removeClass('checked ppdefault');
                     var car_brand = $(this).attr('ids');
                    $('#brand_select').val(car_brand);
                    loadData();
                })
                ...
                function loadData(){
                    ...
                    $.ajax({
                        ...
                        type:'GET',
                        dataType:'json',
                        data:{car_d:car_d,car_price:car_price,brand_select:brand_select,pre_days:pre_days},
                        success:function(msg){
                            var html = '';
                       $.each(msg,function(k,v){
                           html+='<tr id="car87" class="clist_tr carLi carInfo87 " data="" price-flag="0"  style="z-index: 0; height: 79px;">';
        ...
        <div class="zc_boxshd cl-lbox mt10 lmap_box">
            <p class="zc_left_title f14">石家庄&nbsp;正定机场店</p>
            <div class="newmap">
                <iframe id="storeMap" width="268px" height="198px"  scrolling="no" frameborder="0" lazyLoad="https://service.zuche.com/shijiazhuang/mapinclude/959?mapHeight=198&mapWidth=268&fromPage=som"></iframe>
                <div class="shad">
                    <a href="javascript:showBigMap('shijiazhuang','959');" class="mapb">查看大图</a>
                </div>
            </div>
            <dl class="storedl">
                <dt>地&nbsp;&nbsp;址: </dt>
                <dd>石家庄正定机场2号航站楼1层国内到达大厅<a id="monitor_right_transInfo" href="https://shijiazhuang.zuche.com/location/959" target="_blank" class="se_route">线路查询</a></dd>
    ...
    {{if deptInfoDetail }}
        ...
        {{if deptInfoDetail.commentCount > 0 }}
          	<a href="https://shijiazhuang.zuche.com/listremarks-959-1-1-2" target="_blank" class="comment">{{>deptInfoDetail.commentCount }}条评论<i class="argray"></i></a>
        {{/if}}
    {{/if}}
        ...
        <div class="zc_boxshd minhght">
            <ul class="right_tab">
                ...
                <li class="tab w142" onclick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click', '短租-年租');changeOrderType('year');">
                    <a>年租套餐<i>(360-364天)</i><img class="zc_new" src="https://image.zuchecdn.com/newversion/yearrent/new.png"/></a>
                </li>
                <li>
            ...
            <p class="yel_tips"><span class="gift_redlittle"></span>月租28天以上，6折起！GPS导航、不计免赔服务费，7天封顶。</p>
            ...
            <td class="ord">
                ...
                <div class="car_price" style="z-index: 1;">
                    ...
                    <div class="fl clear">
                    <!-- <span class="fl pri_all"><em class="total">总价:</em><em class="rmb">¥</em><em class="num"></em><a class="zcargray_d" href="javascript:;"></a></span> -->
                    </div>
                    </div>
                </div>
                </div>
                <a ids="<?=$v['car_id']?>" class="rent_car od_btn btn_yel zc_bbtn" href="javascript:;">租 车</a>
                </div>
                </td>
            </tr>
            <?php }?>
...
<div class="zc_tool">
    <ul class="ulbox">
        ...
        <li class="libox p-re" id="rtoolorder" >
            <a href="/order" target="_Blank" class="abox" onClick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','侧边-订单')"><span class="zc_record_i"></span>订<br>单<span class="zc_nont_ory"></span><span class="zc_has_ory" style="display:none;"></span></a>
...
<script id="carListTemplate" type="text/x-jsrender">
	{{for models}}
		<tr class="clist_tr carLi carInfo{{>id}} {{if stockCount == 5}}od_none{{/if}}{{if #parent.parent.data.currentModelId == id && carfromflag}}spe_gotop{{/if}}" name="car{{>id}}" id="car{{>id}}"  mode-name="{{>fullName}}" price-flag="{{>hasCheapPrice}}"
			data="{{>stockCount}}-{{if fromIndexPackage == 3 || fromIndexPackage == 4 || fromIndexPackage == 5}}{{>longRentTotalPrice}}{{else}}{{>lowestAvgPrice}}{{/if}}-{{>levelId}}-{{>brandId}}-{{>forgift}}-{{>insurance}}-{{>specialCarType}}-{{>hotFlag}}-{{>seat}}-{{>modePic}}-{{>styleName}}-{{>name}}">
           <td class="pic">
               ...
               <div class="alltips">
				...
				<div class="bh_sale">
					{{for listPrompt  ~parentId=id}}
						{{if imageFlag == 1}}
							<a class="hui" data="{{:~parentId}}-{{:#getIndex()+1}}" url="{{:tipsUrl}}" title="{{:huodongtitle}}"><span class="bred" onclick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click', '短租-异地减免')">惠</span><i class="sale_con">{{>imageTips}}</i></a>
						{{/if}}
						{{if imageFlag == 2}}
           ...
           <td class="ord">
			  <div class="order_box">
				   ...
				   {{else}}
	                   <div class="od_price">
	                        <div class="houfu {{if #parent.parent.parent.data.rentDay >27}}hfset{{/if}}"></div>
	                        <div class="car_price">
								<span class="pri_ye">
	                             	<em class="rmb">¥</em>
				   ...
				   {{if stockCount == 1}}
						{{if fromIndexPackage == 3 || fromIndexPackage == 4 || fromIndexPackage == 5}}
                   		...
                   		{{else}}
                   			<a href='javascript:pickUpCar({{>id}},"","","{{>fullName}}","0","","",{{>levelId}},0,0,{{>standAvgPrice}},{{>standTotalPrice}});' id="bookOrder{{>id}}" class="od_btn btn_yel zc_bbtn" onclick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click', '短租-submit-后付')">租 车</a>
                   		{{/if}}
                   {{else stockCount == 2 || stockCount == 4}}
						{{if fromIndexPackage == 3 || fromIndexPackage == 4 || fromIndexPackage == 5}}
                   		...
                   		{{else #parent.parent.data.rentDay > 27 && #parent.parent.data.orderType == 4}}
							<a href="javascript:void(0);" onclick ='javascript:changeDepartment({{>id}},"{{>fullName}}","{{>levelId}}",0,1,{{>lowestAvgPrice}});' id="changeDepartment{{>id}}" class="change_st od_btn btn_blue zc_bbtn" >换门店<i class="arw arwhit_btm"></i></a>
						{{else}}
			  ...
			  {{if fromIndexPackage != 3 && fromIndexPackage != 4 && fromIndexPackage != 5}}
               	  ...
               	  <div class="spe_order yu_o">
	                   ...
	                   <div class="tip_incon">
	                      <div style="float:left;position:relative;">
		                   ...
		                   <a href="javascript:pickUpCar({{>id}},'','','{{>fullName}}','1','','',{{>levelId}},0,0,{{>preAvgPrice}},{{>preTotalPrice}})"  id="bookOrderPrePay{{>id}}" class="sz_btnOrange" onclick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click', '短租-submit-在线')">
			                   <span class="tr">
		                       	  <em class="all">共优惠:</em>
	              ...
	              {{if hasWorkDayRent || hasWeekRent}}
					 <a href='javascript:pickUpCar({{>id}},"","","{{>fullName}}","0","","",{{>levelId}},0,1,{{>longRentAvgPrice}},{{>longRentTotalPrice}});' id="longRentBookOrder{{>id}}" class="sz_btnOrange" onclick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click', '短租-submit-先付')" >
...
<!----> <script id="changeStoreTemplate" type="text/x-jsrender">
	{{for depPrice}}
		<li class="deta_list">
            ...
            <span class="col col3"><a href="javascript:void(0)" onclick="queryDepInfo('shijiazhuang',{{>code}});">交通线路</a></span>
            <div class="col col4">
                <div class="car_price">
...
<form name="orderForm" id="orderForm" method="post">
    ...
    <input type="hidden" id="fromCityId" name="fromCityId" value="33"/>
    <input type="hidden" id="toCityId" name="toCityId" value="33"/>
    <input type="hidden" id="fromTime" name="fromTime" value="2017-05-24 10:00"/>
    <input type="hidden" id="fromEndTime" name="fromEndTime" value=""/>
    <input type="hidden" id="fromDate" name="fromDate" value="2017-05-24"/>
    <input type="hidden" id="fromHour" name="fromHour" value="10"/>
    <input type="hidden" id="fromMinute" name="fromMinute" value="00"/>
    <input type="hidden" id="rentDay" name="rentDay" value="28"/>

    <input type="hidden" id="toTime" name="toTime" value="2017-06-21 10:00"/>
    <input type="hidden" id="toDate" name="toDate" value="2017-06-21"/>
    <input type="hidden" id="toHour" name="toHour" value="10"/>
    <input type="hidden" id="toMinute" name="toMinute" value="00"/>


    <input type="hidden" id="fromStoreId" name="fromStoreId" value="959"/>
    <input type="hidden" id="fromStoreName" name="fromStoreName" value="正定机场店"/>

    <input type="hidden" id="toStoreId" name="toStoreId" value="959"/>
    <input type="hidden" id="toStoreName" name="toStoreName" value="正定机场店"/>

    <input type="hidden" id="toStockStoreId" name="toStockStoreId" value="959"/>
    <input type="hidden" id="fromStockStoreId" name="fromStockStoreId" value="959"/>
    ...
    <input type="hidden" id="isLongRent" name="isLongRent" value="1"/>
    <input type="hidden" name="clickpositon" id="clickpositon" value="rent">
    <input type="hidden" name="flag" id="flag" value="carListPage">

    <input type="hidden" name="checkMemberId" id="checkMemberId" value="17366592"/>
    <input type="hidden" name="memberId" id="memberId" value="17366592"/>
    <input type="hidden" name="memberLevel" id="memberLevelVal" value="1"/>
...
<script type="text/javascript">
    var pageSystemDate='2017-05-24 09:38';
   // var priceLevel='1';
   // var isHoliday = '';
    //var differCityOrStore = ""==="true";
   // var sentType = "0";
   // var pickType = "0";
    var minDate = '2017-05-24';
    var currentDate = '2017-05-24';
    ...
    seajs.use(['divided/som/entry/lib@9418beaef0'],function(){
        seajs.use('divided/som/entry/cartlist@df03e2be9f');
    });
</script>
</body>
</html>