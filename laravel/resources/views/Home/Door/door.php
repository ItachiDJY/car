...
<head>
    ...
    <meta name="WT.quChe_time_Second" content="2017-05-25 10:00" />
    <meta name="WT.huanChe_time_Second" content="2017-05-27 10:00" />
    <link rel="stylesheet" type="text/css" href="https://css.zuchecdn.com/divided/som/entry/main@977f78b8d9.css" />
</head>
<body class="bodycolor">
<input type="hidden" id="currentDateStr" name="currentDateStr" value="2017-05-24 09:08">
<!--head start -->
...
<div class="zc_headlist zc_boxshd">
    <form id="firstOrderInfo" style="height: auto;">
                ...
                <div class="choose_ul">
                    ...
                    <div class="ch_box cardate" style="z-index:3;">
                        <label class="c_date">取车时间
                            <div class="indexjmhS fromdatetips dayS fromDateWeek">周四</div>
                        </label>
                        <div class="ch_box divin">
                            <input type="text" value="2017-05-25" class="iptdate zc_iptcalendar" name="fromDate" id="fromDate" readonly="readonly" autocomplete="on">
                        </div>
                    ...
                    <div class="ch_box cardate mt10 p-re">
                        ...
                        <div class="ch_box">
                            <input type="text" value="2017-05-27" class="wdate iptDate iptdate zc_iptcalendar" readonly="readonly" name="toDate" id="toDate">
                        </div>
                        <div class="ch_box">
        ...
        <input type="hidden" id="_form_uniq_id" name="_form_uniq_id" value="xJjTpfeo1ObzYPrOq8BNhDvOzGCfgX97" />
...
<form name="orderForm" id="orderForm" method="post">
    ...
    <input type="hidden" id="fromCityId" name="fromCityId" value="33"/>
    <input type="hidden" id="toCityId" name="toCityId" value="33"/>
    <input type="hidden" id="fromTime" name="fromTime" value="2017-05-25 10:00"/>
    <input type="hidden" id="fromEndTime" name="fromEndTime" value=""/>
    <input type="hidden" id="fromDate" name="fromDate" value="2017-05-25"/>
    <input type="hidden" id="fromHour" name="fromHour" value="10"/>
    <input type="hidden" id="fromMinute" name="fromMinute" value="00"/>
    <input type="hidden" id="rentDay" name="rentDay" value="2"/>

    <input type="hidden" id="toTime" name="toTime" value="2017-05-27 10:00"/>
    <input type="hidden" id="toDate" name="toDate" value="2017-05-27"/>
...
<script type="text/javascript">
    var pageSystemDate='2017-05-24 09:08';
    var priceLevel='1';
    var isHoliday = '';
