...
<script>!function(a,b,c,d,e){a[c]=a[c]||{},a[c].env="",a[c].id=d,a[c].st=(new Date).getTime(),a[c].env="test"==a[c].env||"test2"==a[c].env||"pre"==a[c].env?a[c].env:"";var f=[],g=b.createElement("script");g.onload=g.onreadystatechange=function(){if(!g.readyState||/loaded|complete/.test(g.readyState)){g.onload=g.onreadystatechange=null;var a=f.length;if(0==a)return!1;for(var b=0;b<a;b++)"[object Function]"===Object.prototype.toString.call(f[b])&&f[b]()}},g.src="//lc"+a[c].env+".ucarinc.com/lc.js";var h=b.getElementsByTagName("script")[0];h.parentNode.insertBefore(g,h),a[c].putEvt=function(b){return a[c].putBe?(b&&b(),!1):void f.push(b)},a[c].types=e;for(var i=0;i<a[c].types.length;i++)if("pe"==a[c].types[i]){var j=[];a.onerror=function(b,d,e,f){j.push("m="+b+"&u="+d+"&l="+e+"&r="+f),a[c].initPe=j.join(",")};break}}(window,document,"LCTJ","eeffffff",["rc","pe","rt","cl","se"]);</script>
	...
	<meta name="renderer" content="webkit"><meta name="WT.cg_n" content="首页">
...
<input type = "hidden" id="mebId" value = '17272373'>
...
<div class="zc_head_bd">
    <div class="zc_main">
        ...
        <ul class="zc_menu">
            <li class="homecur" >
           	 	<a href="https://www.zuche.com" onClick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','首页-首页（顶）')">首页</a>
            </li>
            <li  >
                <a href="https://order.zuche.com/smfw/index.do?flag=1" onClick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','首页-上门取送（顶）')">上门取送</a>
            </li>
            <li  >
            	<a href="https://order.zuche.com/smfw/index.do?flag=2" onClick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','首页-到店取还（顶）')">到店取还</a>
            </li>
            <li  >
            	<a href="https://changzu.zuche.com" onClick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','首页-长租（顶）')">长租</a>
            </li>
            <li  >
           		<a href="https://carbusiness.zuche.com" onClick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','首页-企业租车（顶）')">企业租车</a>
            </li>
            <li  >
            	<a href="https://easyride.zuche.com" onClick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','首页-顺风车（顶）')">顺风车</a>
            </li>
            <li  >
            	<a href="https://service.zuche.com" onClick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','首页-门店（顶）')">门店</a>
            </li>
            <li>
            	<a href="https://huodong.zuche.com/" onClick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','首页-活动（顶）')">活动</a>
            </li>
            <li  >
           		<a href="https://international.zuche.com" onClick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','首页-国际租车（顶）')">国际租车</a>
           	</li>
        </ul>
...
<div class="indexContents cur" >
    <div class="zc_index_dz bhnew">
    	<input type="hidden" id="currentDate" name="currentDate" value="2017-05-25 17:21:07">
        ...
        <dl class="zc_item_cont fl outpre">
            ...
            <dd>
            	<input type="text" home-flag="true" value="北京" default-value="选择城市"
            ...
            <dd>
            	<input type="hidden" id="fromCityId" name="fromCityId" value="1" >
                <input type="text" value="鲁谷大街店" default-value="请选择取车门店"
            	...
            	<input type="hidden" name="fromStoreId" id="fromStoreId" value="8945">
            	...
            	<label id="shangmensongche_label" class="songchediv" onClick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','短租-送车上门')">送车上门<span class="zc_switch_c icheckbox_polaris " id="shangmensongche"></span></label>
            </dd>
            <dd class="h15"></dd>
        </dl>
        <dl class="zc_item_cont fr bhmt15 outpre">
            ...
            <dd>
            	<input type="hidden" id="toCityId" name="toCityId" value="1" >
                <input type="text" value="鲁谷大街店" default-value="请选择还车门店" 
            	...
            	<input type="hidden" name="toStoreId" id="toStoreId" value="8945">
            	...
            	<div class="areaSelection hide"></div><!-- 还车门店选择区域 -->
            	...
            	<label id="shangmequche_label" class="quchediv" onClick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','短租-上门取车')">上门取车<span class="zc_switch_c icheckbox_polaris " id="shangmequche"></span></label>
            </dd>
            <dd class="h15"></dd>
        </dl>
        <div class="clear"></div>
        <dl class="zc_item_cont bhmt25 w459">
        	...
        	<dd class="p-re h76 ddfl">
                <input type="text" value="2017-05-26" class="inputDay bmnone zc_iptcalendar iptDate dt-left" 
            ...
            <dd class="p-re h76 ddfr">
                <input type="text" value="2017-05-28" class="inputDay bmnone zc_iptcalendar iptDate dt-right" 
        ...
        <div class="clear">
            <input type="button" value="立即选车" class="s_btn" title="立即选车" id="short_goselectcar" onClick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','首页-短租-选车')">
        </div>
    </div>
</div>	            <!-- 短租自驾结束 -->
	            <!--特价套餐开始-->
	    ...
	    <div class="zc_main">
	        <ul>
	            <li>
	                ...
	                <div class="zj"></div>
	                <p>24小时轻松取 / 还车</p>
	                <a href="https://order.zuche.com/smfw/index.do?flag=1" onClick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','首页-短租-我要租车')">我要租车</a>
	            </li>
	            <li class="ml20">
	                <h2>长租服务</h2>
	                <div class="cz"></div>
	                <p>长租一次告别常租</p>
	                <a href="https://changzu.zuche.com" onClick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','首页-长租-我要租车')">我要租车</a>
	            </li>
	            <li class="ml20">
	                <h2>企业租车</h2>
	                <div class="qy"></div>
	                <p>企业出行一步搞定</p>
	                <a href="https://carbusiness.zuche.com" onClick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','首页-企业-我要租车')">我要租车</a>
	            </li>
	            <li class="ml20">
	                <h2>顺风车站</h2>
	                <div class="sfc"></div>
	                <p>价格便宜就是任性</p>
	                <a href="https://easyride.zuche.com" onClick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','首页-顺风车-我要租车')">我要租车</a>
	            </li>
	        </ul>
	    </div>
	</div>
		...
		{{if (recommendDataList && recommendDataList.length > 0) || (morecityList && morecityList.length > 0)}}
			<ul class="city-t">					
				{{for recommendDataList}}
					<li onclick="JavaScript:dcsMultiTrack('DCS.dcsuri', '/virtual/index/teJia/{{>cityInfo.cityEnname}}.event','WT.ti_event', '首页-特价-{{>cityInfo.cityChName }}')" href="javascript:;" id="{{>cityInfo.cityId}}" default-city="{{>cityInfo.cityId}}" class="{{if #index == 0}}cur{{else}} {{/if}}">{{>cityInfo.cityChName}}</li>
				{{/for}}
			</ul>
		{{/if}}
				...
				<div class="more-citybox s-top">
					...
					<ul class="city-tmore">
						{{for morecityList}}
							{{for cityList}}
								<li>
									<a onclick="JavaScript:dcsMultiTrack('DCS.dcsuri', '/virtual/index/teJia/{{>cityEnname}}.event','WT.ti_event', '首页-特价-{{>cityChName}}')" href="javascript:;" id="{{>cityId}}" more-city="{{>cityId}}" >{{>cityChName }}</a>
								</li>
							{{/for}}
						{{/for}}
					</ul>
...
<div class="sale-r sbox">
	<div class="s-top">
		<i>顺风车</i>
		<span class="mcity"><a class="morer" href="https://easyride.zuche.com" onClick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','顺风车-更多城市')">更多&ensp;></a></span>
	</div>
	<div class="salebox sfclist">
		...
		<ul class="rotar" >
								<li class="rotarli">
					<div class="sfcdiv">
						<a  href="javascript:void(0);" onclick="javascript:window.location.href='https://easyride.zuche.com/order/convenienceInfo/227086.html';">
								<div class="sfctop">
									<div class="pricebox">
										<span class="pricebl">¥100</span>
										<span class="priceori">原价:￥359</span>
									</div>
									<div class="picbox">
										<img class="bhmove" src="https://image.zuchecdn.com/newversion/news/order/ky.jpg" alt="" width="320" height="180">
										<img class="car_mask" src="https://image.zuchecdn.com/newversion/news/common/car_mask.png" width="385" height="260">
									</div>
								</div>
								<div class="sfcbotm">
					...
					<li class="rotarli">
					<div class="sfcdiv">
						<a  href="javascript:void(0);" onclick="javascript:window.location.href='https://easyride.zuche.com/order/convenienceInfo/226842.html';">
								<div class="sfctop">
									<div class="pricebox">
										<span class="pricebl">¥100</span>
										<span class="priceori">原价:￥689</span>
									</div>
									<div class="picbox">
								...
								<div class="sfcbotm">
									<div class="distance">
										...
										<div class="carinfo">
											<p>大通G10</p>
											<p class="fs14">大通G10/7座/2.0T自动沪牌   乘坐7人</p>
										</div>							
									</div>
								</div>
							</a>
					...
					<li class="rotarli">
					<div class="sfcdiv">
						<a  href="javascript:void(0);" onclick="javascript:window.location.href='https://easyride.zuche.com/order/convenienceInfo/227132.html';">
								<div class="sfctop">
									<div class="pricebox">
										<span class="pricebl">¥100</span>
										<span class="priceori">原价:￥789</span>
									</div>
									<div class="picbox">
										<img class="bhmove" src="https://image.zuchecdn.com/newversion/news/order/past18.jpg" alt="" width="320" height="180">
										<img class="car_mask" src="https://image.zuchecdn.com/newversion/news/common/car_mask.png" width="385" height="260">
									</div>
								</div>
								<div class="sfcbotm">
									<div class="distance">
										...
										<div class="carinfo">
											<p>大众帕萨特</p>
											<p class="fs14">大众帕萨特/三厢/1.8T自动   乘坐5人</p>
										</div>							
									</div>
								</div>
							</a>
        ...
        <div>
            ...
            <div class="activityScroll">
                ...
                <div class="bd">
                    <ul class="picList">
                                    <li data="1100">
                                        <a href="https://huodong.zuche.com/activityplanning/topic/osmayday.html?szhdbm=20170412_mayday_web" id="newspicture" target="_blank"><img src="http://fimg.zuchecdn.com/upload/web/ActivityList/2017/20170421wuyigengxin_pclist.jpg" width="285" height="215"></a>
                                        <div class="pl10">
                                            <h3 title="五一五一 租五免一">五一五一 租五免一</h3>
                                            <p class="f14" title="神州租车五一租车特惠来袭，五一五一租五免一，即日起至5月1日，租期在......">神州租车五一租车特惠来袭，五一五一租五免一，即日起至5月1日，租期在......</p>
                                            <p class="f12">已有<span class="yellow">5959</span>人参与</p>
                                        </div>
                                        <a href="https://huodong.zuche.com/activityplanning/topic/osmayday.html?szhdbm=20170412_mayday_web" class="ma">立即参与></a>
                                    </li>
                                    <li data="1107">
                                        <a href="http://huodong.zuche.com/activityplanning/topic/SPDBankScard.html?szhdbm=20170509_spd_web" id="newspicture" target="_blank"><img src="http://fimg.zuchecdn.com/upload/web/ActivityList/2017/20170510pufa_pclist.jpg" width="285" height="215"></a>
                                        <div class="pl10">
                                            <h3 title="御驾黑卡--中国出行用车必备信用卡">御驾黑卡--中国出行用车必备信用卡</h3>
                                            <p class="f14" title="中国首张出行“神卡”,一卡尽享神州专车、神州租车、浦发信用卡三大白金......">中国首张出行“神卡”,一卡尽享神州专车、神州租车、浦发信用卡三大白金......</p>
                                            <p class="f12">已有<span class="yellow">5961</span>人参与</p>
                                        </div>
                                        <a href="http://huodong.zuche.com/activityplanning/topic/SPDBankScard.html?szhdbm=20170509_spd_web" class="ma">立即参与></a>
                                    </li>
                                    <li data="1105">
                                        <a href="http://huodong.zuche.com/activityplanning/topic/incomingnewcar.jsp?szhdbm=20170502_inc_web" id="newspicture" target="_blank"><img src="http://fimg.zuchecdn.com/upload/web/ActivityList/2017/20170502wanliang69_pclist.jpg" width="285" height="215"></a>
                                        <div class="pl10">
                                            <h3 title="万辆新车来袭 69元起租">万辆新车来袭 69元起租</h3>
                                            <p class="f14" title="神州租车万辆新车来袭，低至69元起租，适用于全国直营门店（北京、伊犁......">神州租车万辆新车来袭，低至69元起租，适用于全国直营门店（北京、伊犁......</p>
                                            <p class="f12">已有<span class="yellow">5401</span>人参与</p>
                                        </div>
                                        <a href="http://huodong.zuche.com/activityplanning/topic/incomingnewcar.jsp?szhdbm=20170502_inc_web" class="ma">立即参与></a>
                                    </li>
                                    <li data="1110">
                                        <a href="http://huodong.zuche.com/activityplanning/topic/sectionDuanWu.html?szhdbm=20170519_sdw_web&utm_source=guanwang&utm_medium=web&utm_campaign=duanwu" id="newspicture" target="_blank"><img src="http://fimg.zuchecdn.com/upload/web/ActivityList/2017/20170519duanwu_pclist.jpg" width="285" height="215"></a>
                                        <div class="pl10">
                                            <h3 title="端午出游 租五免一">端午出游 租五免一</h3>
                                            <p class="f14" title="神州租车端午租车特惠来袭，端午出游租五免一，即日起至5月30日，租期......">神州租车端午租车特惠来袭，端午出游租五免一，即日起至5月30日，租期......</p>
                                            <p class="f12">已有<span class="yellow">4269</span>人参与</p>
                                        </div>
                                        <a href="http://huodong.zuche.com/activityplanning/topic/sectionDuanWu.html?szhdbm=20170519_sdw_web&utm_source=guanwang&utm_medium=web&utm_campaign=duanwu" class="ma">立即参与></a>
                                    </li>
                    </ul>
                </div>-->
                <div class="hd">
                ...
                <div class="bd">
                    <ul class="picList">
                    	<li>
                            <a href="https://huodong.zuche.com/activityplanning/topic/followzuche5.html?szhdbm=20161111weixin_web" onclick="dcsMultiTrack('DCS.dcsuri', '/virtual/index/AD_R3/20140723.event','WT.ti_event', '首页-右广告3-关注微信','WT.mc_click','首页-活动5-图')" target="_blank">
                                <img src="https://image.zuchecdn.com/newversion/news/huodong/20161228wechat.jpg" width="285" height="215" alt="关注微信">
                            </a>
                            <div class="pl10">
                                <h3>关注微信 领20元租车券！</h3>
                                <p class="f14">话不多说 关注即送租车券<br/>惊喜无限 乐享优惠不停歇</p>
                                <p class="f12"></p>
                                <!--<p class="f12">已有<span class="yellow">888,888</span>人参与</p> -->
                            </div>
                            <a href="https://huodong.zuche.com/activityplanning/topic/followzuche5.html?szhdbm=20161111weixin_web" class="ma" target="_blank" onclick="dcsMultiTrack('DCS.dcsuri', '/virtual/index/AD_R3/20140723.event','WT.ti_event', '首页-右广告3-关注微信','WT.mc_click','首页-活动5-字')">立即参与></a>
                        </li>
                        <li>
                            <a href="https://huodong.zuche.com/activityplanning/topic/SPDBankScard.html?szhdbm=20170509_spd_web" onclick="dcsMultiTrack('DCS.dcsuri', '/virtual/index/AD_R3/20140723.event','WT.ti_event', '首页-右广告3-御驾黑卡','WT.mc_click','首页-活动5-图')" target="_blank">
                                <img src="https://fimg.zuchecdn.com/upload/web/ActivityList/2017/20170510spd_list.jpg" width="285" height="215" alt="御驾黑卡">
                            </a>
                            <div class="pl10">
                                <h3>御驾黑卡--中国出行用车必备信用卡</h3>
                                <p class="f14">中国首张出行“神卡”,一卡尽享神州专车、<br>神州租车、浦发信用卡三大白金权益！</p>
                                <p class="f12"></p>
                                <!--<p class="f12">已有<span class="yellow">888,888</span>人参与</p> -->
                            </div>
                            <a href="https://huodong.zuche.com/activityplanning/topic/SPDBankScard.html?szhdbm=20170509_spd_web" class="ma" target="_blank" onclick="dcsMultiTrack('DCS.dcsuri', '/virtual/index/AD_R3/20140723.event','WT.ti_event', '首页-右广告3-御驾黑卡','WT.mc_click','首页-活动5-字')">立即参与></a>
                        </li>
                        <li>
                            <a href="https://huodong.zuche.com/activityplanning/topic/lowprice.html" target="_blank" onClick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','首页-活动1-图')">
                            	<img src="https://image.zuchecdn.com/newversion/news/huodong/20160311pc_news_03.jpg" width="285" height="215" alt="月租超低价">
                            </a>
                            <div class="pl10">
                                <h3>超值优惠 低至6折！</h3>
                                <p class="f14">
                            ...
                            <a href="https://huodong.zuche.com/activityplanning/topic/lowprice.html" class="ma" target="_blank" onClick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','首页-活动1-字')">立即参与></a>
                        </li>
                        <li>
                            <a href="http://www.gohertz.cn/infor/special_offers/global-offer-10-off" target="_blank" onClick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','首页-活动4-图')">
                            	<img src="https://image.zuchecdn.com/newversion/news/huodong/20160909hertz_web.jpg" width="285" height="215" alt="赫兹全球租车 点我直达！">
                            </a>
                            <div class="pl10">
                                <h3>赫兹全球租车 点我直达！</h3>
                        ...
                        <li>
                            <a href="https://huodong.zuche.com/activityplanning/topic/ojnewmemebr.html?szhdbm=20161031new150_pc" onclick="dcsMultiTrack('DCS.dcsuri', '/virtual/index/AD_R3/20140723.event','WT.ti_event', '首页-右广告3-新用户留步150元请收下','WT.mc_click','首页-活动5-图')" target="_blank">
                                <img src="https://fimg.zuchecdn.com/upload/web/HomePage/ActivityList/2017/20170220Newmember_list.jpg" width="285" height="215" alt="新用户留步150元请收下">
                            </a>
                            <div class="pl10">
                                <h3>新用户留步 150元请收下</h3>
                                <p class="f14">连环送券 租车直抵<br/>专享特惠 只送给你</p>
                                <p class="f12"></p>
                                <!--<p class="f12">已有<span class="yellow">888,888</span>人参与</p> -->
                            </div>
                            <a href="https://huodong.zuche.com/activityplanning/topic/ojnewmemebr.html?szhdbm=20161031new150_pc" class="ma" target="_blank" onclick="dcsMultiTrack('DCS.dcsuri', '/virtual/index/AD_R3/20140723.event','WT.ti_event', '首页-右广告3-新用户留步150元请收下','WT.mc_click','首页-活动5-字')">立即参与></a>
                        </li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="zc_but_box"><a href="https://huodong.zuche.com" target="_blank" class="moreabox" onClick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','活动-更多优惠')">更多优惠></a> </div>
...
<div class="zc_tool">
	<ul class="ulbox">
        ...
        <li class="libox p-re" id="rtoolorder" >
            <a href="https://mycar.zuche.com/queryOrder/queryOrder.do" target="_Blank" class="abox" onClick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','侧边-订单')"><span class="zc_record_i"></span>订<br>单<span class="zc_nont_ory"></span><span class="zc_has_ory" style="display:none;"></span></a>
        ...
        <li class="libox p-re" id="rtoolphone">
            <a href="https://shouji.zuche.com/" target="_blank" class="abox"><span class="zc_phone_i" onClick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','侧边-手机版')"></span>手<br>机<br>版</a>
                ...
                <div class="p-re">
                    ...
                    <div class="rtoolphone">
                        ...
                        <a href="https://itunes.apple.com/cn/app/id454685734?mt=8" rel="nofollow" target="_blank" 
                        	onclick="JavaScript:dcsMultiTrack('DCS.dcsuri', '/virtual/shouoji/down/iphone.event','WT.ti_event', '手机客户端-iPhone下载','WT.mc_click','侧边栏-ios下载')" class="rtooldownbut">iPhone 版下载</a>
                        <a href="https://static.zuchecdn.com/download/SZZC.apk" rel="nofollow" target="_blank"
                        	onclick="JavaScript:dcsMultiTrack('DCS.dcsuri', '/virtual/shouoji/down/android.event','WT.ti_event', '手机客户端-Android下载','WT.mc_click','侧边栏-Android下载')" class="rtooldownbut">Android 版下载</a>
                    </div>
                </div>
            </div>
        </li>
...
<div class="rightsj">◆<span class="arrowicon">◆</span></div>
                    <dl>
                        ...
                        <dd class="carimg">
                            <img src="{{:picture}}" width="132" height="76">
                        </dd>
                        ...
                        <dd class="but_box"><a href="https://mycar.zuche.com/queryOrder/queryOrder.do" target="_Blank" onClick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','侧边栏-查看更多')">查看更多</a> </dd>
                    </dl>
</script>
...
<div class="zc_tool_zuche">
    ...
    <div class="pt15"><a href="https://order.zuche.com" class="zc_yell_w80" onClick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','侧边栏-立即租车')">立即租车</a></div>
</div>
</script>
...
<script type='text/javascript' id='bdshell_js'></script> 	<!-- 右侧浮动层结束 -->
...
<script type="text/javascript" >
	seajs.use([
		'divided/som/entry/lib@9418beaef0',
		'divided/som/entry/common@3fee529603'
	]);
	seajs.use(['divided/som/dcs_tag_zc.js']);
</script>	<script>
		var __currentdatetime = '2017-05-25 17:21:07';
		var pageSystemDate='2017-05-25 17:21:07';
		var __nextdatetime = '2017-05-26';
		var __next2datetime = '2017-05-28';
		var priceLevel='1';//动态加载上门取车价格用
		//长租城市名称，id
		var quCheCityName = "";
			var quCheCityId = "";
		
		seajs.use(['divided/som/entry/lib@9418beaef0'],function(){
			seajs.use('divided/som/entry/index@bf3ab2bb96');
		});
