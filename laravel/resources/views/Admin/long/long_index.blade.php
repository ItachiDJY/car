                        ...
                        <div class="table-responsive">
                            <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                ...
                                @foreach($arr as $key=>$val)
                                    <tr>
                                        <td><input type="checkbox" name="check" value="{{$val -> need_id}}"/></td>
                                        <td>{{$val -> need_id}}</td>
                                        <td>{{$val -> order}}</td>
                                        <td>{{$val -> city}}</td>
                                        <td>{{$val -> pop_time}}</td>
                                        ...
                                        <td>
                                            ...
                                            @elseif($val -> status == 0)
                                                <input type="button" class="no" thisid="{{$val -> need_id}}" value="未审核" style="color: red"/>
                                            @endif
                                        </td>
                                        <td>
                                            <button class="delete" ids="{{$val -> need_id}}">删除</button>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
