                        ...
                        <div class="table-responsive">
                            <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                ...
                                @foreach($arr as $key=>$val)
                                    <tr>
                                        <td><input type="checkbox" name="check" value="<?php echo $val['chit_id']?>"/></td>
                                        <td><?php echo $val['chit_id']?></td>
                                        <td>
                                            <span id="change_name"><?php echo $val['chit_name']?></span>
                                            <input type="text" id="write_name" style="display: none"/>
                                        </td>
                                        <td>
                                            <span id="change_value"><?php echo $val['chit_value']?></span>
                                            <input type="text" id="write_value" style="display: none;"/>
                                        </td>
                                        <td>
                                            <button class="delete" ids="<?php echo $val['chit_id']?>">删除</button>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
...
<script type="text/javascript">
    $(function() {
        ...
        $(document).on("click","#change_value",function() {
            var chit = $(this);
            var chit_value = $(this).html();
            chit.next().css('display','block').val(chit_value);
            chit.html("");
        });
        $(document).on("blur","#write_value",function() {
            var chit = $(this);
            var chit_value = chit.val();
            chit.prev().html(chit_value);
            chit.css("display","none");
            var chit_id = chit.parent().prev().prev().html();
            $.ajax( {
                type:"get",
                url:"/voucher_change_value",
                data: {
