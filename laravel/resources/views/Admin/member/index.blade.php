                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="table-responsive">
                            <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                ...
                                @foreach($arr as $val)
                                    <tr>
                                        <td><input type="checkbox" name="check" value="<?php echo $val['user_id']?>"/></td>
                                        <td><?php echo $val['user_id']?></td>
                                        <td>
                                            <span id="change_name"><?php echo $val['user_name']?></span>
                                            <input type="text" id="write_name" style="display: none"/>
                                        </td>
                                        <td>
                                            <span id="change_phone"><?php echo $val['user_phone']?></span>
                                            <input type="text" id="write_phone" style="display: none;"/>
                                        </td>
                                        <td>
                                            <span id="change_email"><?php echo $val['user_email']?></span>
                                            <input type="text" id="write_email" style="display: none;"/>
                                        </td>
                                        <td><?php echo $val['user_point']?></td>
                                        <td><?php echo $val['user_level']?></td>
                                        <td>
                                            <button class="delete" ids="<?php echo $val['user_id']?>">删除</button>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
...
<script type="text/javascript">
    $(function() {
        ...
        $(document).on("click","#change_phone",function() {
            var phone = $(this);
            var phone_value = $(this).html();
            phone.next().css('display','block').val(phone_value);
            phone.html("");
        });
        $(document).on("blur","#write_phone",function() {
            var phone = $(this);
            var phone_value = phone.val();
            phone.prev().html(phone_value);
            phone.css("display","none");
            var phone_id = phone.parent().prev().prev().html();
            $.ajax( {
                type:"get",
                url:"/member_change_phone",
                data: {
        ...
        $(document).on("click","#change_email",function() {
            var email = $(this);
            var email_value = $(this).html();
            email.next().css('display','block').val(email_value);
            email.html("");
        });
        $(document).on("blur","#write_email",function() {
            var email = $(this);
            var email_value = email.val();
            email.prev().html(email_value);
            email.css("display","none");
            var email_id = email.parent().prev().prev().prev().html();
            $.ajax( {
                type:"get",
                url:"/member_change_email",
                data: {
