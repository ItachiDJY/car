            ...
            <div class="page-content">
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" role="form" method="post" action="/active_add_do" enctype="multipart/form-data">
                            <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 活动名称 </label>
                                <div class="col-sm-9">
                                    <input type="text" name="active_name" id="form-field-1" placeholder="活动名称" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 活动描述 </label>
                                <div class="col-sm-9">
                                    <textarea name="active_describe" id="form-field-1" cols="30" rows="10"placeholder="活动描述" class="col-xs-10 col-sm-5"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 活动图片 </label>
                                <div class="col-sm-9">
                                    <input type="file" name="active_img" id="form-field-1" placeholder="活动图片" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 活动开始时间 </label>
                                <div class="col-sm-9">
                                    <input type="text" name="begin_time" id="form-field-1" placeholder="2007-03-01" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 活动结束时间 </label>
                                <div class="col-sm-9">
                                    <input type="text" name="end_time" id="form-field-1" placeholder="2007-05-21" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
