                        ...
                        <div class="table-responsive">
                            <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                ...
                                @foreach($arr as $key=>$val)
                                    <tr>
                                        <td><input type="checkbox" name="check" value="{{$val -> active_id}}"/></td>
                                        <td>{{$val -> active_id}}</td>
                                        <td>
                                            <span id="change_name">{{$val -> active_name}}</span>
                                            <input type="text" id="write_name" style="display: none"/>
                                        </td>
                                        <td>{{$val -> active_describe}}</td>
                                        <td>
                                            <img src="../{{$val -> active_img}}" alt="" width="150" high="50"/>
                                        </td>
                                        <td><?php echo date('Y-m-d',$val -> begin_time)?></td>
                                        <td><?php echo date('Y-m-d',$val -> end_time)?></td>
                                        <td>
                                            <button class="delete" ids="{{$val -> active_id}}">删除</button>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
