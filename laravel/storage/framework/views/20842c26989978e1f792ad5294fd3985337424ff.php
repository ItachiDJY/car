					...
					<div class="page-content">
							<div class="row">							
								...
								<table class="border_table f_l" border="1" style="width:300px;margin-right:20px;float:left">
									...
									<tbody>
										<tr><th>订单总金额</th><td><?php echo e($one_info['order_amount']); ?></td></tr>
										<tr><th>优惠券金额</th><td><?php echo e($one_info['coupon_amount']); ?></td></tr>
										<tr><th>积分金额</th><td><?php echo e($one_info['discount_amount']); ?></td></tr>
										<tr><th>租车押金</th><td><?php echo e($one_info['foregift']); ?></td></tr>
										<tr><th>服务费</th><td><?php echo e($one_info['service_amount']); ?></td></tr>
										<tr><th>支付金额</th><td><?php echo e($one_info['final_amount']); ?></td></tr>
									</tbody>
								</table>
								...
								<table class="border_table f_l" border="1" style="width:300px;margin-right:40px;float:left">
									...
									<tbody>
										<tr><th>订单号</th><td><?php echo e($one_info['order_no']); ?></td></tr>
										<tr><th>订单状态</th>
										<td>
											<?php if($one_info['order_status'] ==1): ?>
											租赁中
											<?php elseif($one_info['order_status'] ==2): ?>
											已完成
											<?php elseif($one_info['order_status'] ==3): ?>
											已取消
											<?php elseif($one_info['order_status'] == 4): ?>
											预定成功
											<?php endif; ?>
										</td>
										</tr>
										<tr><th>支付状态</th>
										<td>
											<?php if($one_info['pay_status'] == 1): ?>
											已支付
											<?php elseif($one_info['pay_status'] == 2): ?>
											未支付
											<?php endif; ?>
										</td>
										</tr>
										<tr><th>订单时间</th><td><?php echo e($one_info['create_time']); ?></td></tr>
										<tr><th>取车方式</th>
										<td>
											<?php if($one_info['pop_type'] == 0): ?>
											门店自取
											<?php elseif($one_info['pop_type'] == 1): ?>
											送车上门
											<?php endif; ?>
										</td>
										</tr>
										<tr><th>还车方式</th>
										<td>
											<?php if($one_info['return_type'] == 0): ?>
											门店自还
											<?php elseif($one_info['return_type'] == 1): ?>
											上门取车
											<?php endif; ?>
										</td>
										</tr>
										<tr><th>预定天数</th><td><?php echo e($one_info['pre_days']); ?></td></tr>
									</tbody>
								</table>
								...
								<table class="border_table f_l" border="1" style="width:300px;margin-right:40px;float:left">
									...
									<tbody>
										<tr><th>姓名</th><td><?php echo e($user_info['user_name']); ?></td></tr>
										<tr><th>手机号</th><td><?php echo e($user_info['user_phone']); ?></td></tr>
										<tr><th>证件类型</th><td><?php echo e($user_info['id_type']); ?></td></tr>
										<tr><th>证件号</th><td><?php echo e($user_info['id_number']); ?></td></tr>
										<tr><th>取车时间</th><td><?php echo e($one_info['pop_time']); ?></td></tr>
										<tr><th>送车地址</th><td><?php echo e($one_info['pop_address']); ?></td></tr>
										<tr><th>还车时间</th><td><?php echo e($one_info['return_time']); ?></td></tr>
										<tr><th>取车地址</th><td><?php echo e($one_info['return_address']); ?></td></tr>
									</tbody>
								</table>
