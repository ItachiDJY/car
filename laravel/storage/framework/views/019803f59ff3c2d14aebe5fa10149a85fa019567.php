                        ...
                        <div class="table-responsive">
                            <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                ...
                                <?php foreach($arr as $key=>$val): ?>
                                    <tr>
                                        <td><input type="checkbox" name="check" value="<?php echo e($val -> active_id); ?>"/></td>
                                        <td><?php echo e($val -> active_id); ?></td>
                                        <td>
                                            <span id="change_name"><?php echo e($val -> active_name); ?></span>
                                            <input type="text" id="write_name" style="display: none"/>
                                        </td>
                                        <td><?php echo e($val -> active_describe); ?></td>
                                        <td>
                                            <img src="../<?php echo e($val -> active_img); ?>" alt="" width="150" high="50"/>
                                        </td>
                                        <td><?php echo date('Y-m-d',$val -> begin_time)?></td>
                                        <td><?php echo date('Y-m-d',$val -> end_time)?></td>
                                        <td>
                                            <button class="delete" ids="<?php echo e($val -> active_id); ?>">删除</button>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                                </tbody>
