...
<!--    <link href="assets/css/bootstrap.min.css" rel="stylesheet" />-->
    ...
    <!-- Custom CSS -->
    <link href="<?php echo e(URL::asset('assets/css/sb-admin-2.css')); ?>" rel="stylesheet">
                ...
                <div class="panel-body">
                    <form role="form" id="form" method="post" action="/login_to" accept-charset="utf-8">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                <input class="form-control" placeholder="密码" name="admin_pwd" id="admin_pwd" type="password">
                                <span id="pwd"></span>
                            </div>
                            ...
                            <?php /*<a href="index.html" class="btn btn-lg btn-success btn-block">登录</a>*/ ?>
...
<script type="text/javascript">
    $(function(){
        ...
        $("#admin_pwd").blur(function()
        {
            ...
            {
                //提示信息
                $("#pwd").html("<font color='red'>密码必须为6-12位纯数字或字母</font>");
                //全部满足条件
            }else
            {
                //提示信息
