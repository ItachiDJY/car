...
class MemberController extends Controller
{
    ...
    public function index()
    {
        ...
        $arr = $model->selectAll();
        //调用分页方法
        $page = DB::table('user')->paginate(4);
        //渲染展示页面
        return view('admin.member.index',['admin_id'=>$info[0]['admin_id'],'admin_name'=>$info[0]['admin_name'],'arr'=>$arr,'page'=>$page]);
    }
    //删除会员
    ...
    public function level()
    {
        ...
        $arr = $model->selectAll();
        //渲染展示页面
        return view('admin.member.level',['admin_id'=>$info[0]['admin_id'],'admin_name'=>$info[0]['admin_name'],'arr'=>$arr]);
    }
    //会员级别删除
    ...
    public function add()
    {
        ...
        $info = $_SESSION['admin'];
        //渲染展示页面
        return view('admin.member.add',['admin_id'=>$info[0]['admin_id'],'admin_name'=>$info[0]['admin_name']]);
    }
    //添加会员级别操作
